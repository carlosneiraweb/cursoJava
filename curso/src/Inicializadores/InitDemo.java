...
public class InitDemo {
   ...
   
   {
    ...
    static
    {
        System.out.println("Inicializador de clase despues inicializar clase");
        System.out.println("[CLASS] double3 = "+ double3 );
        System.out.println();
    }
    
    {
        System.out.println("Inicializador de instancia antes del metodo main");
    ...
    public static void main(String[] args) {
       ...
       for(int i = 0; i < 2; i++){
           ...
           System.out.println();
           InitDemo id = new InitDemo("saludosssssssssssssssss");
