...
public class CloneSuperficial implements Cloneable{
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
         ...
         System.out.print("Son el mismo objeto e1 y e2 =>" ); 
         ...
         System.out.println(e1.name == e2.name);//false
         System.out.println("edad e1 "+e1.age);
         System.out.println("edad e2 "+e2.age);
         
         System.out.print("El nombre del objeto de Person es el mismo ");
         System.out.println(e1.persona.Name == e2.persona.Name);
         ...
         System.out.println("Tienen la misma referencia e1.person.Name e2.personName ");
         System.out.println(e1.persona.Name == e2.persona.Name);
         
        /*
         Los campos inmutables como String, integer
         se modifican independientementa en cada objeto.
         Los objetos mutables este caso Person
         se modifica el los dos objetos los cambios
         */
