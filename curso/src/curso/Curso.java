...
public class Curso {
    ...
    public static void main(String[] args) {
       ...
       Person[] arr = {uno,dos,tres};
       
       System.out.println("El tamaño de arr es "+ arr.length);
       ...
       Person [] total = nvArr.copyOfTamaño(arr, 0);
        ...
        System.out.println("El tamaño de total es "+cinco.length);
        for(String d : cinco){
            System.out.println(d);
        }
        //Error java.lang.NullPointerException 
        //AL señalar a un objeto null
        //Solo se lanza en caso de ser objetos
        //for (Person person : total) {
            //System.out.println(person.getName());
        //}
        */
